...
export const Banner = () => {
    return (
        <div className="banner w-full md:w-2/3 px-7 mx-auto relative flex items-center-justify-between border-solid">
            ...
            <div className="banner-image w-full md:w-1/2 p-3 flex justify-end">
                <img src={require("../assets/images/tmp.png")} alt="banner" className="max-h-95" />
            </div>
        </div>
    )
}